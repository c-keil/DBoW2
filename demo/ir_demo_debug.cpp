...
const int NIMAGES = 1;
const string dir = "/media/colin/box_data/kri_day_stereo/cam_3/gluestick_freq1/matched_descriptors/";
const string desc1 = "1689805124015000105.npy";
...
void testDatabase(const vector<vector<vector<float>>> &features)
{
  ...
  IRVocabulary2 voc("/home/colin/Research/ir/DBoW2/vocs/crunch_vocs/gluestick_all_matched_descriptors_downsamp2_L5_k10.yml.gz");
  
  IRDatabase2 db(voc, true, 2); // false = do not use direct index
  // IRDatabase2 db(voc, true, 2); // false = do not use direct index
  db.load("/home/colin/Research/ir/slam_ws/mapping_results_tmp/databaseKRI_day.yml");
